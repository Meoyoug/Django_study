...
SECRET_KEY = "django-insecure-3mrdw#e-v^r74k1!bne5g3xyvr1#kjyniscp53us+f0mxarso3"
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        "rest_framework_simplejwt.authentication.JWTAuthentication",# Simple JWT 인증 사용
